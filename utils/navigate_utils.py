...
def navigate_join_rally_window(thread):
    ...
    ongoing_rally_btn_img = cv2.imread('assets/540p/join_rally/ongoing_rally_btn.png')
    ...
    time.sleep(1)
    src_img = thread.capture_and_validate_screen()
    alliance_war_window_option_img = cv2.imread('assets/540p/join_rally/alliance_war_window_option.png')
...
def ensure_and_setup_pvp_war_window_screen(thread):
    alliance_war_window_tag_img = cv2.imread('assets/540p/join_rally/alliance_war_window_tag.png')
    battle_logs_btn_img = cv2.imread('assets/540p/join_rally/battle_logs_btn.png')
    pvp_war_tab_img = cv2.imread('assets/540p/join_rally/pvp_war_tab.png')
    src_img = thread.capture_and_validate_screen()
    ...
    war_checked_img = cv2.imread('assets/540p/join_rally/war_checked.png')
    war_unchecked_img = cv2.imread('assets/540p/join_rally/war_unchecked.png')
